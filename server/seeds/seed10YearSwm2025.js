/**
 * Seed script: Import 10-YEAR SWM PLAN data (2025) from Excel into MongoDB
 *
 * Usage:  node seeds/seed10YearSwm2025.js
 */
...
const EXCEL_PATH = path.resolve(__dirname, "../../front-end/docs/eswm_universe_2025.xlsx");
...
async function seed() {
  ...
  const deleted = await TenYearSWMPlan.deleteMany({ dataYear: 2025 });
  console.log(`Cleared ${deleted.deletedCount} existing 2025 records.`);
