/**
 * Seed script: Import FUNDED MRF data from Excel into MongoDB
 *
...
async function seed() {
  ...
  const inserted = await FundedMRF.insertMany(records);
  console.log(`Inserted ${inserted.length} records into funded_mrf collection.`);
