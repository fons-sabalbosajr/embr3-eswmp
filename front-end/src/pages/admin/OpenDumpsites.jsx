...
export default function OpenDumpsites() {
    ...
    <div>
      ...
      <Row gutter={[12, 12]} style={{ marginBottom: 16 }}>
        <Col xs={24} sm={12} lg={6}>
          <Card size="small" hoverable className="ods-card" style={{ borderRadius: 10, borderLeft: "3px solid #1a3353", height: "100%" }}>
            <Statistic title="Total Sites" value={filtered.length} prefix={<DeleteOutlined className="ods-icon-bounce" style={{ color: "#1a3353" }} />} />
