...
export default function Reports() {
  ...
  const fetchCompanies = useCallback(async () => {
    try {
      ...
      setCompanies(data);
      secureStorage.setJSON("reports-companies-cache", {
        data,
        ts: Date.now(),
      });
    } catch {
  ...
  useEffect(() => {
    ...
    return () => {
      socket.off("data-refresh", handler);
    };
  }, [fetchTransactions]);
        ...
        <Row gutter={[12, 12]} style={{ marginBottom: 16 }}>
          ...
          <Col xs={24} sm={8} md={5}>
            ...
            >
              ...
              <Option value="baseline_update_request">
                Baseline Update Request
              </Option>
              <Option value="baseline_update_approved">
                Baseline Update Approved
              </Option>
        ...
        {detailRecord && (
          <Descriptions column={1} bordered size="small">
            <Descriptions.Item label="Date">
              {dayjs(detailRecord.createdAt).format("MMM DD, YYYY hh:mm:ss A")}
            </Descriptions.Item>
            ...
            <Descriptions.Item label="Company Type">
              {detailRecord.companyType || "—"}
            </Descriptions.Item>
            <Descriptions.Item label="Type">
              <Tag
                color={TYPE_CONFIG[detailRecord.type]?.color}
                icon={TYPE_CONFIG[detailRecord.type]?.icon}
              >
            ...
            {detailRecord.meta && (
              <Descriptions.Item label="Meta">
                ...
                >
                  {JSON.stringify(detailRecord.meta, null, 2)}
                </pre>
              </Descriptions.Item>
            )}
          </Descriptions>
