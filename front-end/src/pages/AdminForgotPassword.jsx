...
export default function AdminForgotPassword() {
  ...
  const brandDesc = {
    1: "Enter your registered email address and we'll send you a 6-digit code to reset your admin account password.",
  ...
  const renderStep = () => {
    ...
    if (step === 3) {
      return (
        <>
          ...
          <Form name="admin-new-pw" size="large" onFinish={onResetPassword} layout="vertical" requiredMark={false} style={{ marginTop: 24 }}>
    ...
    return (
      <>
        ...
        <Form name="admin-forgot-password" size="large" onFinish={onSendCode} layout="vertical" requiredMark={false} style={{ marginTop: 24 }}>
