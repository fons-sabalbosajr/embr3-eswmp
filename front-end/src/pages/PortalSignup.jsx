            ...
            <Form form={form} name="portal-signup" size="large" onFinish={onFinish} layout="vertical" requiredMark={false} className="auth-form">
              ...
              <Divider style={{ margin: "4px 0 16px" }}>
                <Text type="secondary" style={{ fontSize: 13 }}>
                  <FileProtectOutlined /> Verification Document
                </Text>
              </Divider>
              <div style={{ padding: "12px 16px", background: "#f0f5ff", borderRadius: 8, border: "1px solid #adc6ff", marginBottom: 16, fontSize: 13, color: "#1d39c4", lineHeight: 1.6 }}>
                Upload a copy of the <strong>authorization letter from the office</strong> confirming you are the legitimate portal registrant. Accepted: JPG, PNG, PDF, DOC, DOCX (max {MAX_FILE_MB} MB).
              </div>
              <Form.Item label="Authorization Letter / Proof of Identity">
                <Upload
                  maxCount={1}
